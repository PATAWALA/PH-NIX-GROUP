    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt="Projet paysager PHÉNIX GROUP"
          fill
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mt-3 mb-6 font-serif leading-tight">
              Prêt à créer votre jardin d'exception ?
            </h2>
            <p className="text-stone-300 text-lg mb-8 leading-relaxed">
              Notre équipe de paysagistes experts est prête à vous accompagner dans la réalisation 
              de vos rêves d'aménagement extérieur les plus ambitieux.
            </p>
              ...
              <div className="relative flex items-center gap-4">
                ...
                <div>
                  ...
                  <a 
                    ...
                    className="text-emerald-400 font-semibold text-lg hover:text-emerald-300 transition-colors"
                  >
                    +2250142550779
                  </a>
                </div>
