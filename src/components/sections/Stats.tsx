...
const values = [
  ...
  },
  {
    icon: Award,
    title: 'Savoir-faire',
    description: "16 ans d'expérience et une équipe de paysagistes passionnés par la beauté du travail bien fait."
  },
  {
    icon: Users,
    title: 'Confiance',
      ...
      <div className="relative max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mt-3 mb-6 font-serif">
            L'excellence paysagère comme standard
          </h2>
          ...
          {values.map((value, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500/20 to-emerald-700/20 flex items-center justify-center mb-6">
        ...
        >
          ...
          <Link href="/contact">
            <Button 
              variant="outline" 
              size="lg"
              className="border-emerald-500 text-emerald-400 hover:bg-emerald-500 hover:text-white transition-colors w-full sm:w-auto"
            >
